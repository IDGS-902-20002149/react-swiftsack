    ...
    const obtenerProducto = async () => {
      try {
        const response = await axios.get(
          `https://localhost:7267/api/Productos/${id}`
        );
        ...
        <div className="row px-xl-5">
          ...
          <div className="col-lg-7 h-auto mb-3">
            <div className="h-100 bg-light p-3">
              ...
              <div
                className="input-group quantity m-3"
                style={{ width: "130px" }}
              >
                <div className="input-group-btn">
                  <button
                    className="btn btn-outline-dark btn-minus"
                    onClick={restar}
                  >
                ...
                <div className="input-group-btn">
                  <button
                    className="btn btn-outline-dark btn-plus"
                    onClick={sumar}
                  >
            ...
            <div className="bg-light p-30">
              <div className="nav nav-tabs mb-4">
                <a
                  ...
                  href="#tab-pane-1"
                >
                  M&aacute;s Información
                </a>
              </div>
              <div className="tab-content p-3">
                <div className="tab-pane fade show active" id="tab-pane-1">
                  <h4 className="mb-3">
                    Información adicional de {producto.nombre}
                  </h4>
                  <p>
